...
SOURCEFILES_QUOTED_IF_SPACED=../src/C4add.c ../src/ff-pic24-30-33.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1360937237/C4add.o ${OBJECTDIR}/_ext/1360937237/ff-pic24-30-33.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1360937237/C4add.o.d ${OBJECTDIR}/_ext/1360937237/ff-pic24-30-33.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1360937237/C4add.o ${OBJECTDIR}/_ext/1360937237/ff-pic24-30-33.o

# Source Files
SOURCEFILES=../src/C4add.c ../src/ff-pic24-30-33.s
...
${OBJECTDIR}/_ext/1360937237/C4add.o: ../src/C4add.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/C4add.c  -o ${OBJECTDIR}/_ext/1360937237/C4add.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1360937237/C4add.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -msmall-code -msmall-data -mconst-in-code -O0 -I"/home/mikael/git/PIC24-30-33/FF" -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/_ext/1360937237/C4add.o: ../src/C4add.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/C4add.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/C4add.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/C4add.c  -o ${OBJECTDIR}/_ext/1360937237/C4add.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1360937237/C4add.o.d"      -mno-eds-warn  -g -omf=elf -msmall-code -msmall-data -mconst-in-code -O0 -I"/home/mikael/git/PIC24-30-33/FF" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/C4add.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/FF.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/FF.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--no-data-init,--no-pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/FF.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/FF.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--no-data-init,--no-pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
