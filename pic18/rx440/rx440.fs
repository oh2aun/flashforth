...
\ #sendm pic18/rx440/strcat pic18/rx440/i2c-base-b
\ #sendm pic18/rx440/pll 
\ #sendm pic18/rx440/rx440
...
: det-set
  if2Offset rxOffset 2@ d+ bfo lo2
  mode @ case
    modeAm  of amOn det-am  bfo-off endof
    modeUsb of amOn det-ssb bfo-on endof
    modeLsb of amOn det-ssb bfo-on endof
  endcase
;
: filter-set
  filter @ case
