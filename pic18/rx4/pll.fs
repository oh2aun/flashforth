...
: split ( u -- c c ) dup 8 rshift ;
: >i2c1txb ( c -- ) i2c.txbe i2c1txb c! ;
: si5351.pll! ( n c n c reg -- )
  si5351 i2c.write
  7 i2c1cnt c! i2c1txb c! i2c.start 
  >i2c1txb split >i2c1txb >i2c1txb
  >i2c1txb split >i2c1txb >i2c1txb
  i2c.stop 
;
...
\ FM vfo. 76.8 - 97.3 MHz, AM BFO
: fm.init
  #8 to divider
  %1111.1101 SI_OE_CONTROL si5351.c!   \ clk1 on
  SI_SYNTH_MS_1 msynt-int!
...
: lo.init
  ...
  lo1-level SI_CLK_SRC_PLLA or SI_CLK2_CONTROL si5351.c! \ LO1 45-67 MHz
...
: lo-off lo1-level $80 + $12 s! ;
: lo-on  lo1-level $12 s! ;
