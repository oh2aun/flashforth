...
: i2c.init ( -- )
  ...
  $21 rc2pps c!           \ SCL
  $22 rc3pps c!           \ SDA
  %010.011 i2c1sdapps c!  \ RC3 SDA
  %010.010 i2c1sclpps c!  \ RC2 SCL
  pps-
  $0c anselc mclr    \ digital PC2 PC3
  $0c odconc mset    \ open drain PC2 PC3
  $0c latc mclr
  $0c trisc mclr     \ output PC2 PC3
  $0c slrconc mset
  $04 i2c1con0 c!
  $80 i2c1con1 c!
  $20 i2c1con2 c!    \ fast mode, adb 
\  $03 i2c1clk  c!    \ MFINTOSC 500 KHz, 125 KHz 12c clock
  $01 oscfrq c!      \ 1 MHz HFINTOSC 250 KHz i2c clock
  $40 oscen c!
